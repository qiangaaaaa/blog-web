        ...
        <div class="form">
            ...
            <div class="form__content">
                ...
                <div class="styled-input">
                    <!-- 用户名 -->
                    <input type="text" class="styled-input__input" name="nickname" v-model="loginAccount">
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            nav.src = require('common/login.js')  //静态资源
        }
    }
</script>
<style scoped>
    ...
    * {
    ...
    .styled-input__placeholder-text .letter .active {
        animation: letterAnimIn 0.25s ease forwards !important;
        -webkit-animation: letterAnimIn 0.25s ease forwards !important;
    }
